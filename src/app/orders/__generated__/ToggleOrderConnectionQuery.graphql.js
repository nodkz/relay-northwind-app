/**
 * @flow
 * @relayHash 1c660ef2c7d1aebea8d7e7f4c5d849be
 */
...
export type ToggleOrderConnectionQueryResponse = {|
  +viewer: ?{| |};
|};
*/
...
/*
query ToggleOrderConnectionQuery(
...
const batch /*: ConcreteBatch*/ = {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ToggleOrderConnectionQuery",
    "selections": [
      {
        "kind": "LinkedField",
        "alias": "viewer",
    ...
    "selections": [
      {
        ...
        "selections": [
          ...
          },
          {
            ...
            "handle": "connection",
            "name": "orderConnection",
            "key": "OrderConnection_orderConnection",
            "filters": [
              "filter"
            ]
          }
  ...
  "text": "query ToggleOrderConnectionQuery(\n  $filter: FilterFindManyOrderInput\n) {\n  viewer {\n    ...OrderConnection_viewer\n  }\n}\n\nfragment OrderConnection_viewer on Viewer {\n  orderConnection(first: $count, after: $cursor, filter: $filter) {\n    count\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    edges {\n      cursor\n      node {\n        __typename\n        _id\n        ...OrderConnectionItem_order\n        id\n      }\n    }\n  }\n}\n\nfragment OrderConnectionItem_order on Order {\n  id\n  orderID\n  customerID\n  employeeID\n  shipVia\n  customer {\n    companyName\n    id\n  }\n  shipper {\n    companyName\n    id\n  }\n  employee {\n    firstName\n    lastName\n    id\n  }\n  orderDate\n  freight\n}\n"
};
